...
3. **[Widgets](Widgets.md)** — All 19 widget types explained, how to add/edit/remove widgets, and every configuration option
...
| Widget library | 19 types across Display, Charts, Control, and Utility categories |
